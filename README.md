...
AURA (AI-based Unified Risk Assessment), **fizik tabanlı algoritmalar** ve **yapay zeka destekli risk değerlendirme yaklaşımları** kullanarak orman yangınlarının yayılımını simüle eden, analiz eden ve yangının kontrol edilebilirliğini tahmin eden gelişmiş bir simülasyon yazılımıdır.

Sistem; rüzgar, sıcaklık, nem, kuraklık, ağaç türü ve yangın geometrisinin fraktal karmaşıklığını eş zamanlı değerlendirerek **gerçekçi, tutarlı ve güvenilir** sonuçlar üretmeyi hedefler.
...
- Eğitim, araştırma ve senaryo bazlı risk değerlendirmeleri için bir temel oluşturmak  

AURA, hâlâ BETA sürümünde olduğu için **operasyonel afet yönetimi** sırasında kullanılması tavsiye edilmez.  
AURA 1.0; **analitik, akademik ve deneysel** kullanım için tasarlanmıştır.
