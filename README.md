...
AURA (AI-based Unified Risk Assessment), yapay zeka destekli bir yangın simülasyon ve tahmin programıdır. Fizik tabanlı algoritmalarla çalışarak, en gerçekçi ve güvenilir sonuçları sunar.
...
```bash
pip install mlx numpy matplotlib scipy pillow requests urllib3 --break-system-packages
```
...
```bash
cd "AURA 2.0-ML | AI-based Unified Risk Assessment"
